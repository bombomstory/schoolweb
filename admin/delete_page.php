<?php
	...
	$reading=get_creading($_GET["did"])+1;
	$sql="update ".$CFG->prefix."contents set reading=".$reading." where id=".$_GET["did"];
	$rs=mysqli_query($conn,$sql);

	$sql="select * from ".$CFG->prefix."contents where id=".$_GET["did"];
	$rs=mysqli_query($conn,$sql);
